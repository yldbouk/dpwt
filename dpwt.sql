...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 06, 2019 at 01:12 AM
...
INSERT INTO `job_data` (`id`, `jobName`, `reason`, `date`, `jobStatus`, `createdBy`, `location`, `reviewedBy`, `fileLocation`) VALUES
...
(30, 'Test ', 'Iâ€™m a dev I can do what I want!', '2019-02-02 03:20:52', 'purge', 'Help', NULL, 'Help', NULL),
...
--
-- DATA REDACTED DUE TO SENSITIVE USER DATA
--
...
INSERT INTO `printer_data` (`id`, `name`, `friendlyname`, `grade`, `filamentColor`, `locked`) VALUES
(1, 'orion', 'CeeMeCNC Orion Delta', 8, 'purple', 0);
