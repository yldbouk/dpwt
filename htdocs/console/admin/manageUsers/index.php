       ...
       ?>
          ...
          <form method='post' id="editform" action='scripts/editUsers.script.php'>
            ...
            if($perms == "awaitingAction"){
              ...
              if($type != "password") echo '|<button style="background:none!important;color:#fc5f50;border:none;padding:0!important;font:inherit;border-bottom:1pxsolid#444;cursor:not-allowed;"type="button"onclick="alert(`Account is authenticated through Google.`);"><b><i>Reset Password</i></b></button>|';
